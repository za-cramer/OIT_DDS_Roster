%include 'L:\IR\consult\OIT\OrgRoster\roster_init.sas';
...
from
	...
	LEFT JOIN ciwdb.GL_FISCAL_ROLES_TBL c
		on fund.FndDeptId = c.FR_DEPT_ID
...
proc SQL;
create table BudgetPosFndPct&FY._fnd_dept as
select
    p.*,
